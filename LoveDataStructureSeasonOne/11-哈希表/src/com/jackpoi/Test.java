...
import com.jackpoi.map.LinkedHashMap;
import com.jackpoi.map.Map;
import com.jackpoi.map.TreeMap;
import com.jackpoi.model.Cat;
import com.jackpoi.model.Key;
import com.jackpoi.model.SubKey1;
import com.jackpoi.model.SubKey2;
...
public class Test {
    ...
    static void test1() {
        String filepath = "F:\\Java\\src\\java\\util";
        ...
        test2Map(new java.util.TreeMap<>(), words);
        test2Map(new java.util.HashMap<>(), words);
        test2Map(new java.util.LinkedHashMap<>(), words);
    }
